...
public class ZAPIMsgHandler extends BaseApiHandler {
    ...
    private Function getStatisticalProcessedTime = new Function() {
         ...
         * @param statePTime
         * @param pTime
         * @param state null to get sum processed time,
         *              true to get min processed time,
         *              false to get max processed time
         * @return -1L if failed
         */
        @Override
        public long excuteFunc(long userId, long msgId, Boolean state, long beginValue) {
            ...
            if (state == null) {
                ...
                if (state) {
                    ...
                    beginValue = Math.max(beginValue, pTime);
                }
            }
    ...
    public Double getAverageProcessedTimeByUser(long userId) {
        ...
        Long totalMsg = getTotalMsgByUser(userId);
    ...
    public Double getAverageProcessedTimeBySender(long senderId) {
        ...
        Long totalMsg = getTotalMsgBySender(senderId);
        if ((totalMsg == null) || (totalMsg == 0))
            return null;
